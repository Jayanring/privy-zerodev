import { KernelFactoryStakerAbi, KernelV3AccountAbi, KernelV3FactoryAbi, KernelV3_1AccountAbi, createKernelAccount } from "@zerodev/sdk";
...
export const deserializePermissionAccount = async (client, entryPoint, kernelVersion, modularPermissionAccountParams, modularSigner) => {
    ...
    const { index, validatorInitData, useMetaFactory } = decodeParamsFromInitCode(params.accountParams.initCode, kernelVersion);
    ...
    if (deployWithFactoryFunctionData.functionName === "deployWithFactory") {
        ...
        if (initializeFunctionData.functionName === "initialize") {
            validatorInitData = {
                ...
                initConfig: isKernelVersionAfter(kernelVersion, "0.3.1") &&
